...
Citizen.Trace("\n")
Citizen.Trace("\n")
Citizen.Trace("MENU PESSOAL v2.0 by ESX-Brasil")
Citizen.Trace("\n")
Citizen.Trace("Created for ESX FrameWork")
Citizen.Trace("\n")
Citizen.Trace("ESX-Brasil for any Support")
Citizen.Trace("\n")
Citizen.Trace("\n")
Citizen.Trace("\n")
Citizen.Trace("\n")
...
Citizen.CreateThread(function()
	...
	while playerGroup == nil do
		ESX.TriggerServerCallback('Esx-MenuPessoal:Admin_getUsergroup', function(group) playerGroup = group end)
		Citizen.Wait(10)
	end
...
RegisterNetEvent("Esx-MenuPessoal:Weapon_addAmmoToPedC")
AddEventHandler("Esx-MenuPessoal:Weapon_addAmmoToPedC", function(value, quantity)
	AddAmmoToPed(plyPed, value, quantity)
end)

-- Admin Menu --

RegisterNetEvent('Esx-MenuPessoal:Admin_BringC')
AddEventHandler('Esx-MenuPessoal:Admin_BringC', function(plyPedCoords)
...
function admin_tp_playertome()
	...
	if plyId ~= nil then
		...
		if type(plyId) == 'number' then
			...
			print(plyId)
			TriggerServerEvent('Esx-MenuPessoal:Admin_BringS', plyId, plyPedCoords)
		end
	end
end
...
function admin_give_money()
	...
	if amount ~= nil then
		...
		if type(amount) == 'number' then
			TriggerServerEvent('Esx-MenuPessoal:Admin_giveCash', amount)
		end
	end
end
...
function admin_give_bank()
	...
	if amount ~= nil then
		...
		if type(amount) == 'number' then
			TriggerServerEvent('Esx-MenuPessoal:Admin_giveBank', amount)
		end
	end
end
...
function admin_give_dirty()
	...
	if amount ~= nil then
		...
		if type(amount) == 'number' then
			TriggerServerEvent('Esx-MenuPessoal:Admin_giveDirtyMoney', amount)
		end
	end
end
...
--drive
	if Config.EnableESXDriver then
...
function AddMenuFacturesMenu(menu)
	...
	ESX.TriggerServerCallback('Esx-MenuPessoal:Bill_getBills', function(bills)
		for i = 1, #bills, 1 do
										...
										if pedAmmo > 0 then
											if post == true then
												if quantity <= pedAmmo and quantity >= 0 then
													...
													TriggerServerEvent('Esx-MenuPessoal:Weapon_addAmmoToPedS', personalmenu.closestPlayer, value, quantity)
		...
		if item == recruterItem then
			if ESX.PlayerData.job.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('Esx-MenuPessoal:Boss_recruterplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name, 0)
				end
			else
		...
		elseif item == virerItem then
			if ESX.PlayerData.job.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('Esx-MenuPessoal:Boss_virerplayer', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		elseif item == promouvoirItem then
			if ESX.PlayerData.job.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('Esx-MenuPessoal:Boss_promouvoirplayer', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		elseif item == destituerItem then
			if ESX.PlayerData.job.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('Esx-MenuPessoal:Boss_destituerplayer', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		...
		if item == recruter2Item then
			if ESX.PlayerData.job2.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('Esx-MenuPessoal:Boss_recruterplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name, 0)
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		elseif item == virer2Item then
			if ESX.PlayerData.job2.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('Esx-MenuPessoal:Boss_virerplayer2', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		elseif item == promouvoir2Item then
			if ESX.PlayerData.job2.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('Esx-MenuPessoal:Boss_promouvoirplayer2', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		elseif item == destituer2Item then
			if ESX.PlayerData.job2.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('Esx-MenuPessoal:Boss_destituerplayer2', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
