...
Config.EnableESXIdentity = false -- ative se você estiver usando 'jsfour-id card' para mostra sua indentidade.
Config.EnableESXDriver = false -- ative ser estiver usando 'jsfour-id card' para mostra carteira de motorista.
